...
function renderCourseCard(items){
  ...
  if (categoryFilter && categoryFilter.value !== "all") {
    filteredItems = filteredItems.filter((course) => course.category === categoryFilter.value)
  }

  // if any platform is selected this will change the items based on the selected platform
  if(platformFilter && platformFilter.value !== "all"){
    filteredItems = filteredItems.filter((course)=> course.platform === platformFilter.value)
  }
